        ...
        <div class="row user-administration-list">
            ...
            ?>
                <div class="user-box col-12 row user-administration-list-item">
                    ...
                    <div class="col-1">
                        <a href="<?= "?action=showUsers&amount=$amount&offset=$offset&deleteUser=" . $user->getId() ?>" class="btn btn-danger">X</a>
                    </div>
                    <div class="col-1">
            ...
            <div class="mt-5 col-12 row p-0">
                <div class="mt-2 mb-2 col-12">
                    <p>Showing users <?= $offset + 1 ?> - <?= $offset + sizeof($users) ?> ( <?= $usersAmount ?> total )</p>
                </div>
        ...
        <div class="row user-administration-list">
            ...
            ?>
                <div class="user-box col-12 row user-administration-list-item">
                    ...
                    <div class="col-1">
                        <a href="<?= "?action=searchUsers&username=" . $searchName . "&deleteUser=" . $user->getId() ?>" class="btn btn-danger">X</a>
                    </div>
                    <div class="col-1">
                        <a href="<?= "?action=showUser&id=" . $user->getId() ?>" class="btn btn-primary"><i class="bi bi-search"></i></a>
                    </div>
